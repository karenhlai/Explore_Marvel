...
// fetch(`http://gateway.marvel.com/v1/public/characters?limit=2&offset=2&ts=${key.ts}&apikey=${key.publicKey}&hash=${hash}`)
//   .then(res => res.json())
//   // .then(myJson => filterEvents(myJson))
//   .then(myJson => console.log(myJson.data.results))
